...
import { followOrUnfollowUser, getProfile, getSavedPosts, getSuggestions, login, logout, register, searchUser, updateProfile } from '../controllers/user.controller.js';
